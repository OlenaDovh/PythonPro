...
# try:
#     raise HealingEvent(10, 500, 1000, 50)
# except GameEventException as e:
#     print(e)
#
# try:
#     raise DeathEvent(5, "boss attack", "Library of Zoltun Kulle")
# except GameEventException as e:
#     print(e)

# try:
#     raise LevelUpEvent(5, 6, 14000)
# except GameEventException as e:
#     print(e)
#
# try:
#     raise UpgradeEvent('Chained Spear', 10, 800)
# except GameEventException as e:
#     print(e)
#
# try:
#     raise InvincibilityEvent(2)
# except GameEventException as e:
#     print(e)

# def upgrade(skill: str, new_skill_level: int, cost: int | float):
#     raise GameEventException("upgrade",
#                              {"skill_name": skill,
#                               "new_skill_level": new_skill_level,
#                               "upgrade_cost": cost})

#
# def level_up(old_level: int, new_level: int, bonus_experience: int):
#     raise GameEventException("level_up",
#                              {"old_level": old_level,
#                               "new_level": new_level,
#                               "bonus_experience": bonus_experience})


# def death(time_for_respawn, reason, place_of_respawn):
...
# def invincible(time_of_invincibility):
#     raise GameEventException("invincible",
#                              {"time_of_invincibility": time_of_invincibility})
#

# def healing(healing_time, health_lvl_before, health_lvl_after, healing_percentage):
#     raise GameEventException("upgrade",
#                              {"healing_time": healing_time,
#                               "health_lvl_before": health_lvl_before,
#                               "health_lvl_after": health_lvl_after,
...
# def get_event_type(event: GameEventException):
#     match event.event_type:
#         case "upgrade":
#             print(f"Your skill '{event.details['skill']}' "
#                   f"was upgraded to the next level '{event.details['new_skill_level']}'. "
#                   f"You have used {event.details['cost']} coins")
#
#
# try:
#     get_event_type(upgrade('mana', 2, 15))
# except GameEventException as e:
#     print(e)
